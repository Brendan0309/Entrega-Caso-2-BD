-- CASO 2: CONSULTAS MISCELANEAS Y T-SQL
...
-- MERGE
----- Usado para editar las ciudades con nombre asemejados a provincias por Repetido
...
---- El TVP se debe inicializar primero
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES (@InstitutionId, GETDATE(), 1, 'Generado TVP');
...
('Extra Room Access', 1, '2', 2, 10000, 0.2, 0.1, 8000, 9000);

EXEC sp_UpsertProviderContract 
    @ProviderName = 'Delta Company',
    @AddressId = 8,
    @Conditions = @contract;
