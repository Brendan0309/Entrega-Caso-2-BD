...
class DatabaseMigrator:
    ...
    def _extract_data(self):
        ...
        query = """
            SELECT permissionid, description, code, moduleid
            FROM Payment_Permissions
        """
    ...
    def _get_max_id(self):
        ...
        with self.sqlserver_conn.cursor() as cursor:
            cursor.execute("SELECT MAX(permissionId) FROM caipiDb.dbo.caipi_Permissions")
    ...
    def _insert_data(self, df):
        ...
        with self.sqlserver_conn.cursor() as cursor:
            for _, row in df.iterrows():
                ...
                cursor.execute("""
                    INSERT INTO caipiDb.dbo.caipi_Permissions 
                    (description, code, moduleid)
                    VALUES (?, ?, ?)
